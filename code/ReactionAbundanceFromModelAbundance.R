...
####################
## Load Models
# obj_metabolicModelsMouse <- readRDS("/home/lena/Dropbox/0_Work/0_Projects/18_EnrichedEnvironmentJena/metagenome/metamouse_HQBins-20211001.RDS")
# 
...
obj_metabolicModelsMouse <- readRDS("./activeReactions_Stefano/fva_99_reactions_thr06.RDS")
...
rm(df_rxnAnnotation)
obj_metabolicModelsMouse <- readRDS("../mouseMetagenome/metamouse-20230510.RDS")
for(obj_model in obj_metabolicModelsMouse){
